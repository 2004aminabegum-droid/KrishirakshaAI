              ...
              {activeTabs.map((tab) => {
                ...
                return (
                  <Link
                    ...
                    className={`group relative flex items-center justify-center rounded-xl p-2 sm:p-2.5 transition-all ${isActive
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <div className="relative" ref={menuRef}>
                <button
                  ...
                  aria-haspopup="true"
                  className={`flex items-center gap-2 rounded-2xl border px-2.5 py-1.5 text-xs font-bold transition-all ${profileMenuOpen
                  ...
                  <div className="absolute right-0 mt-2.5 w-80 max-w-[calc(100vw-2rem)] origin-top-right rounded-3xl border border-slate-800 bg-slate-900/95 p-4 shadow-2xl backdrop-blur-xl ring-1 ring-white/5 animate-fadeIn z-50 space-y-4">
                    ...
                    <div className="flex items-center gap-3 border-b border-slate-800/80 pb-3.5">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <span className={`inline-block mt-1 rounded-full px-2 py-0.5 text-[9px] font-extrabold uppercase tracking-wider ${effectiveRole === 'officer'
                    ...
                    <div className="space-y-1">
                      <Link
                        ...
                        className={`flex items-center gap-3 rounded-xl px-3 py-2.5 text-xs font-bold transition-all ${pathname === '/profile'
                      ...
                      <Link
                        ...
                        onClick={() => setProfileMenuOpen(false)}
                        className={`flex items-center gap-3 rounded-xl px-3 py-2.5 text-xs font-bold transition-all ${pathname.startsWith('/dashboard')
                            ? 'bg-green-600 text-white shadow-md shadow-green-600/30'
                            : 'text-slate-300 hover:bg-slate-800 hover:text-white'
                          }`}
                      >
                        ...
                        {[
                          ...
                          return (
                            <button
                              ...
                              className={`flex flex-col items-center justify-center rounded-xl py-2 px-1 text-xs font-bold transition-all ${isSelected
                                  ? 'bg-green-600 text-white shadow-md shadow-green-600/30'
